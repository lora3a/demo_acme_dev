...
//  Defines
#define NODE_PACKET_SIZE        NODE_DS18B20_SIZE
#define NODE_CLASS              NODE_DS18B20_CLASS
#define USES_FRAM               0
#define SENSOR_POWER_PIN        DS18_PWR_PIN

//  Variables
static ds18_t ds18;
static node_ds18b20 node_data;
...
//  Format Sensor Data
void format_ds18b20_info(int bln_hex, char *msg);

//  Sensor specific functions pointers
//
//  Read Sensor
void (*sensor_read_ptr)(void) = &ds18b20_sensor_read;
//  Format Sensor Data
void (*format_info_ptr)(int, char *) = &format_ds18b20_info;
...
int main(void)
{
    ...
    default:
        ...
        printf("\n");
        printf("-------------------------------------\n");
        printf("-    Test Node-DS18B20 Berta-H10    -\n");
