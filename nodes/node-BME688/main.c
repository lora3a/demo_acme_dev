...
void bme688_sensor_read(void)
{
    ...
    printf(
        "SIGNATURE: %04d, NODE_CLASS: %02d, CPUID: %s, VCC: %04d, VPANEL: %04d, TEMP: %05d, HUM: %05d, PRESS: %4d, GAS: % 9ld.\n",
    ...
    printf(
        "SIGNATURE: %04X, NODE_CLASS: %02X, CPUID: %s, VCC: %04X, VPANEL: %04X, TEMP: %04X, HUM: %04X, PRESS: %X, GAS: %lX.\n",
        node_data.header.signature,
        node_data.header.s_class, cpuid,
        node_data.header.vcc, node_data.header.vpanel,
        node_data.temperature, node_data.humidity,
