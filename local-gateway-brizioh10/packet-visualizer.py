...
def report_node_type(strjson, cfg_dict):
    ...
    s_time = "@ {0:02d}:{1:02d}:{2:02d}.{3:03d}".format(
        ltime.tm_hour, ltime.tm_min, ltime.tm_sec, ms
    )
    if lensj != 0:
...
if "CMT1_ENABLED" in cfg_dict:
    ...
    if cfg_dict["CMT1_ENABLED"] == 1:
        if "CMT1_CPU_ID" in cfg_dict:
            ...
            print(
                "Cfg : CMT1_CPU_ID missing, CMT1_ENABLED default to %d"
                % cfg_dict["CMT1_ENABLED"]
            )
else:
    cfg_dict["CMT1_ENABLED"] = 0
...
if "CMT2_ENABLED" in cfg_dict:
    ...
    if cfg_dict["CMT2_ENABLED"] == 1:
        if "CMT2_CPU_ID" in cfg_dict:
            ...
            print(
                "Cfg : CMT2_CPU_ID missing, CMT2_ENABLED default to %d"
                % cfg_dict["CMT2_ENABLED"]
            )
else:
    cfg_dict["CMT2_ENABLED"] = 0
